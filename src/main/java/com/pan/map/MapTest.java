...
//        map.put("001","姓名,年龄");
        ...
        map.put("005",new Student("王五",21));
        map.put("003",new Student("赵六",23));
        map.put("008",new Student("金七",22));
        map.put("006",new Student("孙八",24));
        map.put("001",new Student("张三2",23));
...
//        set,map 无序的时候，不能使用下标的方式
        ...
        // V get(key)
        //   System.out.println(map.get("007"));
...
//            return false;
            if (obj instanceof Integer || obj instanceof String) {
                return i != null & i.equals(Integer.parseInt(obj.toString()));
            }
            return false;
        }
